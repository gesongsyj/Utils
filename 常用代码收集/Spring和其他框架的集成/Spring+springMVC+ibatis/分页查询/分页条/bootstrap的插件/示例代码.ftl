...
<body>
	...
	<!-- 网页顶部导航 -->
	<#include "common/head-tpl.ftl" /> <#assign currentNav="personal" />
	<!-- 网页导航 -->
	...
	<div class="container">
		<div class="row">
			...
			<!-- 功能页面 -->
			<div class="col-sm-9">
				<form action="/ipLog.do" name="searchForm" id="searchForm"
					...
					<div class="form-group">
						...
						<script type="text/javascript">
						 	$('.form-control option[value=${qo.state}]').prop("selected",true);
						</script>
					</div>
					<div class="form-group">
